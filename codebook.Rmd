...
The purpose of this codebook is to provide complementary commentary on the data analysis performed as per the "Getting and Cleaning Data" course project Week 4 peer-graded assignment. 

The final tidy data set is contained within the "wearable_tidy_dataset" where a step by step code (with commentary) is provided within run_analysis.R file.

A breakdown and a quick summary of the data can be seen below:
